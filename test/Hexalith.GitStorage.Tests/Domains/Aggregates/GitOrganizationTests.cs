...
public class GitOrganizationTests
{
    ...
    {
        // Arrange
        GitOrganization aggregate = new("existing-id", "ExistingOrg", null, "account1", GitOrganizationVisibility.Public, GitOrganizationOrigin.Synced, null, GitOrganizationSyncStatus.Synced, null, null, null, false);
    ...
    {
        // Arrange
        GitOrganization aggregate = new("account1-testorg", "testorg", "Old Description", "account1", GitOrganizationVisibility.Public, GitOrganizationOrigin.Synced, "old-remote", GitOrganizationSyncStatus.NotFoundOnRemote, null, null, null, false);
        DateTimeOffset syncedAt = DateTimeOffset.UtcNow;
    ...
    {
        // Arrange
        GitOrganization aggregate = new("account1-testorg", "testorg", "Old Description", "account1", GitOrganizationVisibility.Public, GitOrganizationOrigin.Synced, null, GitOrganizationSyncStatus.Synced, null, null, null, false);
    ...
    {
        // Arrange
        GitOrganization aggregate = new("account1-testorg", "testorg", "Same Description", "account1", GitOrganizationVisibility.Public, GitOrganizationOrigin.Synced, null, GitOrganizationSyncStatus.Synced, null, null, null, false);
    ...
    {
        // Arrange
        GitOrganization aggregate = new("account1-testorg", "testorg", null, "account1", GitOrganizationVisibility.Public, GitOrganizationOrigin.Synced, null, GitOrganizationSyncStatus.Synced, null, null, null, false);
    ...
    {
        // Arrange
        GitOrganization aggregate = new("account1-testorg", "testorg", null, "account1", GitOrganizationVisibility.Public, GitOrganizationOrigin.Synced, null, GitOrganizationSyncStatus.NotFoundOnRemote, null, null, null, false);
        GitOrganizationMarkedNotFound markedNotFound = new("account1-testorg", DateTimeOffset.UtcNow);
    ...
    {
        // Arrange
        GitOrganization aggregate = new("account1-testorg", "testorg", null, "account1", GitOrganizationVisibility.Public, GitOrganizationOrigin.Synced, null, GitOrganizationSyncStatus.Synced, null, null, null, true);
        GitOrganizationDisabled disabled = new("account1-testorg");
