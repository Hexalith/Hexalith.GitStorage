// <copyright file="GetGitStorageAccountIds.cs" company="ITANEO">
...
public partial record GetGitStorageAccountIds(
    [property: DataMember(Order = 1)] int Skip,
    [property: DataMember(Order = 2)] int Take,
    [property: DataMember(Order = 5)] IEnumerable<string> Results) : IChunkableRequest
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GetGitStorageAccountIds"/> class.
    /// </summary>
    /// <param name="skip">The number of items to skip.</param>
    /// <param name="take">The number of items to take.</param>
    public GetGitStorageAccountIds(int skip, int take)
        : this(skip, take, [])
    {
    }
    ...
    /// Initializes a new instance of the <see cref="GetGitStorageAccountIds"/> class.
    /// </summary>
    public GetGitStorageAccountIds()
        : this(0, 0, [])
    {
    }
