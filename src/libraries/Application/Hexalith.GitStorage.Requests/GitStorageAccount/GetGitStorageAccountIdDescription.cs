// <copyright file="GetGitStorageAccountIdDescription.cs" company="ITANEO">
...
public partial record GetGitStorageAccountIdDescription(string Id, [property: DataMember(Order = 2)] IdDescription? Result = null)
    : GitStorageAccountRequest(Id);