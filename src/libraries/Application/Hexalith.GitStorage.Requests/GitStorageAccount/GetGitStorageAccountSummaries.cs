// <copyright file="GetGitStorageAccountSummaries.cs" company="ITANEO">
...
public partial record GetGitStorageAccountSummaries(
    ...
    [property: DataMember(Order = 5)] IEnumerable<GitStorageAccountSummaryViewModel> Results) : ISearchChunkableRequest
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GetGitStorageAccountSummaries"/> class.
    /// </summary>
    public GetGitStorageAccountSummaries()
        : this(0, 0, null, [], [])
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="GetGitStorageAccountSummaries"/> class with specified skip, take, and search values.
    /// </summary>
    /// <param name="skip">Number of records to skip for pagination.</param>
    /// <param name="take">Maximum number of records to return.</param>
    /// <param name="search">Optional search term to filter results.</param>
    public GetGitStorageAccountSummaries(int skip, int take, string? search = null)
        : this(skip, take, search, [], [])
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="GetGitStorageAccountSummaries"/> class with specified warehouse IDs.
    /// </summary>
    /// <param name="ids">The list of warehouse IDs to search by.</param>
    public GetGitStorageAccountSummaries(IEnumerable<string> ids)
        : this(0, 0, null, ids, [])
    {
    }
    ...
    public ICollectionRequest CreateResults(IEnumerable<object> results)
        => this with { Results = (IEnumerable<GitStorageAccountSummaryViewModel>)results };
}