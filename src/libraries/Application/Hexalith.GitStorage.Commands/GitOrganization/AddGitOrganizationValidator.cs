// <copyright file="AddGitOrganizationValidator.cs" company="ITANEO">
...
/// <summary>
/// Validator for <see cref="AddGitOrganization"/> command.
/// </summary>
public partial class AddGitOrganizationValidator : AbstractValidator<AddGitOrganization>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AddGitOrganizationValidator"/> class.
    /// </summary>
    /// <param name="localizer">The localizer for validation messages.</param>
    public AddGitOrganizationValidator(IStringLocalizer<Labels> localizer)
    {
